...
$route['page/secure-shell-servers/continent/(:any)/(:any)/(:num)'] = 'welcome/server/$2';
//Auth route
...
$route['admin/servers.html'] = 'admin/servers';
...
$route['panel/(:any)/dashboard.html'] = 'member/dashboard';
...
//setting
$route['panel/(:any)/settings.html'] = 'member/settings';
...
//voucher
$route['panel/(:any)/voucher.html'] = 'member/voucher';
...
//keranjang
$route['panel/(:any)/keranjang.html'] = 'member/keranjang';
